...
@Component({
  ...
  template: `
    <nav class="tabs" aria-label="Staff">
      @for (tab of visibleTabs; track tab.path) {
        <a class="tab" [routerLink]="['/staff', tab.path]" routerLinkActive="active">
...
export class StaffTabsComponent {
  readonly tabs: StaffTab[] = [
    { path: 'teachers', labelKey: 'staff.tabs.teachers', permissions: ['STAFF_READ'] },
    { path: 'non-teaching', labelKey: 'staff.tabs.nonTeaching', permissions: ['STAFF_READ'] },
  ];

  constructor(private auth: AuthService) {}

  get visibleTabs(): StaffTab[] {
