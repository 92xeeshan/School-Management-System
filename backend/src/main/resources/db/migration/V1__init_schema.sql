...
-- Conventions: UUID PKs, school_id on every tenant table, VARCHAR enums
-- with CHECK constraints, TIMESTAMPTZ audit columns on every entity table.
-- RLS helper functions are created here; policies are enabled in V4.
-- =====================================================================
